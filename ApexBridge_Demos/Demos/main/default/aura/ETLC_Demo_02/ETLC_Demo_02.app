<aura:application extends="force:slds" >
    ...
    <div class="slds-m-around_xx-large">
        <div class="slds-text-heading_medium">Schedule Demo</div>
        <table>
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td colspan="2">
                    <ui:inputDateTime aura:id="demoWhen" label="When" class="slds-form-element__control slds-input fullWidth"
